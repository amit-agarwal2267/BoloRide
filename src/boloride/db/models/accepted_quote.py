...
class AcceptedQuote(Base):
    ...
    pre_discount_estimated_total: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
    offer_id: Mapped[UUID | None] = mapped_column(PostgreSQLUUID(as_uuid=True))
    offer_code: Mapped[str | None] = mapped_column(String(64))
    offer_display_name: Mapped[str | None] = mapped_column(String(160))
    offer_discount_type: Mapped[str | None] = mapped_column(String(32))
    offer_percentage: Mapped[Decimal | None] = mapped_column(Numeric(5, 2))
    offer_maximum_discount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
    offer_discount_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
